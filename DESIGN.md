...
typography:
  ...
  promo:
    ...
    fontWeight: 700
    lineHeight: 1.15
  # full numeric type scale actually used across the app (landing + app
  # surfaces, including icon glyphs); named roles above are the semantic
  # anchors, this scale is the authoritative set of allowed sizes
  scale:
    step-11: "11px"
    step-12: "12px"
    step-13: "13px"
