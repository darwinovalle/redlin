...
const AppLayout = () => {
  ...
  <Box sx={{ position: 'relative', display: 'flex', width: '100%', minHeight: '100vh', zIndex: 5, background: 'var(--color-shell)', overflow: 'hidden' }}>
      ...
      {/* <Box sx={{ position: 'fixed', top: 10, left: 10, zIndex: 4000, bgcolor: 'var(--color-teal)', color: 'var(--color-white)', px: 1.5, py: 0.75, borderRadius: 999, fontSize: 12, fontWeight: 700 }}>
        APP LAYOUT
      </Box> */}
