...
const FeynmanPanel = ({ documentId }) => {
  ...
  if(!documentId){
    return <Box sx={{ p:3, display:'flex', alignItems:'center', justifyContent:'center', height:'100%' }}><Typography color="text.secondary">Select a document to start Feynman practice.</Typography></Box>;
  }
  if(loading){
